...
internal class ShapeFactory : IShapeFactory
{
    ...
    {
        var body = _shapeBuilder.StartPoint(15, 1).MakeShape(new[] { (0, 0), (0, 1), (1, 1), (1, 0) }, _physicsWorld.MakEditor());
    ...
    {
        var body = _shapeBuilder.StartPoint(15, 3).MakeShape(new[] { (0, 0), (1, 0), (2, 0), (3, 0) }, _physicsWorld.MakEditor());
    ...
    public Shape MakeL1()
    {
        var body = _shapeBuilder.StartPoint(15, 7).MakeShape(new[] { (2, 0), (1, 0), (0, 0), (0, 1) }, _physicsWorld.MakEditor());
    ...
    public Shape MakeL2()
    {
        var body = _shapeBuilder.StartPoint(15, 1).MakeShape(new[] { (2, 1), (1, 1), (0, 1), (0, 0) }, _physicsWorld.MakEditor());
    ...
    public Shape MakeS1()
    {
        var body = _shapeBuilder.StartPoint(15, 3).MakeShape(new[] { (2, 0), (1, 0), (1, 1), (0, 1) }, _physicsWorld.MakEditor());
